    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == buttonDetectPlane) {
            ...
            if (flightCodes.getText().equals("")) {
                ...
                JOptionPane.showMessageDialog(null, "The radar needs to now where the plane came from and where it's going to!");
            } // end else if
            else {
        ...
        if (e.getSource() == buttonLeavesAirspace) {
            if ((aircraftManagementDatabase.getStatus(managementRecordIndex).equalsIgnoreCase("FREE"))
                ...
                JOptionPane.showMessageDialog(null, "To leave the airspace, the aircraft must have the status of 1 or 18");
            } // end if/else
            updateRecords();
        }//end if
